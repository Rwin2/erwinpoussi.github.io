...
### Current status
This project is in an **early stage**. The demonstration shows **low-level motor rate control** using **RRT-based trajectory tracking** along a spiral path in a **3D Gaussian Splat reconstructed environment**.
