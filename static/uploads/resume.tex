...
\usepackage[top=0.4in,bottom=0.3in,left=0.55in,right=0.55in]{geometry}
...
\begin{center}
  ...
  \textit{Building autonomous systems that learn to act --- from foundation model training and sim-to-real robot deployment to LLM-driven scientific agents.}
\end{center}
...
\begin{itemize}
  \item \textbf{Foundation Model Training --- Imitation Learning \& Sim-to-Real Transfer:} Trained vision-language-action (VLA) policies for autonomous drone navigation via behavioral cloning and DAgger. \textit{(\href{https://rwin2.github.io/erwinpoussi.github.io/project/language-steered-drones/}{project page})}
  \begin{itemize}[topsep=0pt]
    \item Reached \textbf{90\% navigation success} (up from 52\%) using RRT* planning, MPC expert demonstrations, and CLIPSeg grounding to 3D Gaussian Splats.
  \end{itemize}
  \item \textbf{GAIT --- Agentic Scene Understanding for Robotic Open-Vocabulary Navigation} (Jun.--Sep.\ 2026): Built a graph-memory architecture and robotic navigation framework for VLA models, leveraging online semantic scene graph construction with interrupt-triggered re-planning. \textit{(\href{https://rwin2.github.io/erwinpoussi.github.io/project/gait/}{project page})}
\end{itemize}

\entry{Stanford School of Medicine, Qiu Lab}{Palo Alto, CA}{Oct.\ 2025 -- Present}
\begin{itemize}
  \item \textbf{ML Researcher --- \href{https://www.pantheon-os.com/}{Pantheon-CLI}:} Multi-agent LLM framework for autonomous scientific discovery with tool-augmented inference for genomic analysis. \textit{(\href{https://rwin2.github.io/erwinpoussi.github.io/publication/xu-2026-pantheonos/}{project page})}
  \begin{itemize}[topsep=0pt]
    \item Fine-tuned Qwen3 LLMs via SFT + RLOO for a self-evolving agent backbone; built actor-critic RL for gene panel selection in scRNA-seq.
  \end{itemize}
  \item \textbf{Virtual Embryo Challenge --- 3D Convolutional Models for Embryogenesis} (Jun.--Sep.\ 2026): Training foundational 3D models to reproduce embryogenesis at both cell-level gene expression and morphogenesis; co-building the \href{https://virtualembryo.ai/challenge}{Virtual Embryo Challenge}. \textit{(\href{https://rwin2.github.io/erwinpoussi.github.io/project/virtual-embryo/}{project page})}
\end{itemize}

\entry{Inspirit AI}{San Francisco, CA}{Jul.\ 2026 -- Aug.\ 2026}
\begin{itemize}
  \item \textbf{AI Instructor:} Taught ML, neural networks, and AI for social good to scholars; designed hands-on sessions and guided real-world AI projects culminating in deployed applications.
\end{itemize}

\entry{Stevens Institute of Technology, RRG}{Hoboken, NJ}{Apr.\ 2025 -- Aug.\ 2025}
\begin{itemize}
  \item \textbf{Research Intern --- ML-Based Aerodynamic Modeling:} Multi-fidelity ML framework (random forests + genetic algorithms) for parachute permeability under rarefied conditions; \textbf{$<$1\% mean error}. \textit{(\href{https://rwin2.github.io/erwinpoussi.github.io/project/parachute-opt/}{project page})}
\end{itemize}
...
\noindent\textbf{Awards:} French Gov.\ Excellence Scholarship $\cdot$ 2\textsuperscript{nd}, 2021 Youth Olympiads (Legion of Honor) $\cdot$ 1\textsuperscript{st} nationwide, 2020 Burkina Faso A-levels $\cdot$ 2020--18 Excellence Awards
